...
class Primerize_Custom(Singleton):
    ...
    def design(
        ...
        if not isinstance(mut_list, util_class.Construct_List):
            is_success = False
            print(
                "\033[41mFAIL\033[0m: \033[91mIllegal\033[0m type of given \033[92mmut_list\033[0m. Should be \033[94mConstruct_List\033[0m.\n"
            )
            return Design_Plate(
                {
                    "sequence": sequence,
        ...
        try:
            ...
            print(
                "\033[41mERROR\033[0m: Primerize Custom design() encountered error.\n"
            )
